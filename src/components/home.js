...
import photo3 from './static/cultural.jpeg';
...
<h5 className="font-bold">Room Roster</h5>
...
<a className="mt-auto mb-0 font-semibold leading-normal text-sm group text-slate-500" target={'_blank'} href="https://newhorizoncollegeofengineering.in/hostels/">
Read More
...
<h5 className="pt-2 mb-6 font-bold text-white"> Room Roster </h5>
...
<p className="ml-2 leading-normal text-sm"><span className="font-bold">Active</span> from Jan 24,2024</p>
